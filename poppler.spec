...
Source0  : https://poppler.freedesktop.org/poppler-22.07.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-22.07.0.tar.xz.sig
...
%prep
%setup -q -n poppler-22.07.0
cd %{_builddir}/poppler-22.07.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657034847
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/poppler-22.07.0/COPYING %{buildroot}/usr/share/package-licenses/poppler/06877624ea5c77efe3b7e39b0f909eda6e25a4ec
cp %{_builddir}/poppler-22.07.0/COPYING3 %{buildroot}/usr/share/package-licenses/poppler/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/poppler-22.07.0/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/poppler/ff3ed70db4739b3c6747c7f624fe2bad70802987
pushd clr-build-avx2
%make_install_v3  || :
popd
pushd clr-build
