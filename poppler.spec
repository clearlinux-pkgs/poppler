...
Source0  : https://poppler.freedesktop.org/poppler-24.04.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-24.04.0.tar.xz.sig
...
%prep
%setup -q -n poppler-24.04.0
cd %{_builddir}/poppler-24.04.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712000201
mkdir -p clr-build
pushd clr-build
...
%files extras
%defattr(-,root,root,-)
/V3/usr/lib64/libpoppler-qt5.so.1.33.0
/V3/usr/lib64/libpoppler-qt6.so.3.4.0
...
/usr/lib64/libpoppler-qt5.so.1.33.0
/usr/lib64/libpoppler-qt6.so.3.4.0
...
/V3/usr/lib64/libpoppler.so.136.0.0
...
/usr/lib64/libpoppler.so.136
/usr/lib64/libpoppler.so.136.0.0
