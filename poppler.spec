...
Source0  : https://poppler.freedesktop.org/poppler-24.08.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-24.08.0.tar.xz.sig
...
Requires: poppler-locales = %{version}-%{release}
...
%package locales
Summary: locales components for the poppler package.
Group: Default

%description locales
locales components for the poppler package.
...
%setup -q -n poppler-24.08.0
cd %{_builddir}/poppler-24.08.0
pushd ..
cp -a poppler-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722635442
mkdir -p clr-build
pushd clr-build
...
-DENABLE_UTILS=ON \
-DENABLE_LIBOPENJPEG=none  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
pushd ../buildavx2/
...
cp %{_builddir}/poppler-%{version}/COPYING3 %{buildroot}/usr/share/package-licenses/poppler/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
cp %{_builddir}/poppler-%{version}/cmake/modules/COPYING-CMAKE-SCRIPTS %{buildroot}/usr/share/package-licenses/poppler/ff3ed70db4739b3c6747c7f624fe2bad70802987 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
%files extras
%defattr(-,root,root,-)
/V3/usr/lib64/libpoppler-qt5.so.1.36.0
...
/usr/lib64/libpoppler-qt5.so.1.36.0
...
/V3/usr/lib64/libpoppler-qt6.so.3.7.0
/V3/usr/lib64/libpoppler.so.140.0.0
...
/usr/lib64/libpoppler-qt6.so.3.7.0
/usr/lib64/libpoppler.so.140
/usr/lib64/libpoppler.so.140.0.0
