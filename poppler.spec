...
Source0  : https://poppler.freedesktop.org/poppler-24.03.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-24.03.0.tar.xz.sig
...
%prep
%setup -q -n poppler-24.03.0
cd %{_builddir}/poppler-24.03.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709490645
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libpoppler.so.135.0.0
...
/usr/lib64/libpoppler.so.135
/usr/lib64/libpoppler.so.135.0.0
