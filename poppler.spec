...
%prep
%setup -q -n poppler-23.10.0
cd %{_builddir}/poppler-23.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696519888
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libpoppler.so.132.0.0
...
/usr/lib64/libpoppler.so.132
/usr/lib64/libpoppler.so.132.0.0
