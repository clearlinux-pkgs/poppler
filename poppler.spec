...
Source0  : https://poppler.freedesktop.org/poppler-24.02.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-24.02.0.tar.xz.sig
...
%prep
%setup -q -n poppler-24.02.0
cd %{_builddir}/poppler-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706891544
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libpoppler.so.134.0.0
...
/usr/lib64/libpoppler.so.134
/usr/lib64/libpoppler.so.134.0.0
