...
Source0  : https://poppler.freedesktop.org/poppler-23.03.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-23.03.0.tar.xz.sig
...
%prep
%setup -q -n poppler-23.03.0
cd %{_builddir}/poppler-23.03.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677774312
mkdir -p clr-build
pushd clr-build
