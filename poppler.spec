...
Source0  : https://poppler.freedesktop.org/poppler-23.11.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-23.11.0.tar.xz.sig
...
%prep
%setup -q -n poppler-23.11.0
cd %{_builddir}/poppler-23.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698879399
mkdir -p clr-build
pushd clr-build
...
/V3/usr/lib64/libpoppler.so.133.0.0
...
/usr/lib64/libpoppler.so.133
/usr/lib64/libpoppler.so.133.0.0
