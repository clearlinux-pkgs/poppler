...
Source0  : https://poppler.freedesktop.org/poppler-24.07.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-24.07.0.tar.xz.sig
...
%setup -q -n poppler-24.07.0
cd %{_builddir}/poppler-24.07.0
pushd ..
cp -a poppler-24.07.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720100795
mkdir -p clr-build
pushd clr-build
...
%files extras
%defattr(-,root,root,-)
/V3/usr/lib64/libpoppler-qt5.so.1.35.0
...
/usr/lib64/libpoppler-qt5.so.1.35.0
...
/V3/usr/lib64/libpoppler-qt6.so.3.6.0
/V3/usr/lib64/libpoppler.so.139.0.0
...
/usr/lib64/libpoppler-qt6.so.3.6.0
/usr/lib64/libpoppler.so.139
/usr/lib64/libpoppler.so.139.0.0
