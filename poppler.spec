...
Source0  : https://poppler.freedesktop.org/poppler-22.11.0.tar.xz
Source1  : https://poppler.freedesktop.org/poppler-22.11.0.tar.xz.sig
...
%prep
%setup -q -n poppler-22.11.0
cd %{_builddir}/poppler-22.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667329546
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libpoppler.so.125
/usr/lib64/glibc-hwcaps/x86-64-v3/libpoppler.so.125.0.0
...
/usr/lib64/libpoppler.so.125
/usr/lib64/libpoppler.so.125.0.0
