...
Source0  : https://poppler.freedesktop.org/poppler-0.76.1.tar.xz
Source99 : https://poppler.freedesktop.org/poppler-0.76.1.tar.xz.sig
...
%prep
%setup -q -n poppler-0.76.1
pushd ..
cp -a poppler-0.76.1 buildavx2
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1557097443
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
...
export RANLIB=gcc-ranlib
export NM=gcc-nm
export CFLAGS="$CFLAGS -O3 -falign-functions=32 -fcf-protection=full -ffat-lto-objects -flto=4 -fno-math-errno -fno-semantic-interposition -fno-trapping-math -fstack-protector-strong -march=haswell "
export FCFLAGS="$CFLAGS -O3 -falign-functions=32 -fcf-protection=full -ffat-lto-objects -flto=4 -fno-math-errno -fno-semantic-interposition -fno-trapping-math -fstack-protector-strong -march=haswell "
export FFLAGS="$CFLAGS -O3 -falign-functions=32 -fcf-protection=full -ffat-lto-objects -flto=4 -fno-math-errno -fno-semantic-interposition -fno-trapping-math -fstack-protector-strong -march=haswell "
export CXXFLAGS="$CXXFLAGS -O3 -falign-functions=32 -fcf-protection=full -ffat-lto-objects -flto=4 -fno-math-errno -fno-semantic-interposition -fno-trapping-math -fstack-protector-strong -march=haswell "
